...
const input = /^[0-9a-zA-Z]{1,}[@]{1}[a-z]{1,}[.]{1}[a-z]{2,3}$/

function sub() {
    var subscribe=document.getElementById("email").value;
    if (!(subscribe=="")){
...
function validateForm() {
    ...
    const subjectInput = document.querySelector('.contact__input[type="text"]');
